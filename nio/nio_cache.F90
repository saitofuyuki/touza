...
! Created: Nov 9 2022
#define TIME_STAMP 'Time-stamp: <2022/12/14 22:18:09 fuyuki nio_cache.F90>'
!!!_! MANIFESTO
!
! Copyright (C) 2022
...
!!!_  - public procedures
  ...
  public init_group
  public cache_scan_file, show_cache
...
101 format(A,' = ', I0)
  ...
  if (ierr.eq.0) call cache_scan_file(ierr, c, u)
  if (ierr.eq.0) call show_cache(ierr, c, tag='cache', levv=+9)
