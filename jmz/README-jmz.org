...
Finally, argument =-qqqqq= further refrains the coordinate columns,
...
| LADD             |   2 |      1 | lazy ADD                                                         |
| LAND             |   2 |      1 | lazy AND                                                         |
| LAY LLAY         |   2 |      1 | background layer; B if A outside, else A                         |
| LDIV             |   2 |      1 | lazy DIV                                                         |
...
| SIZE=ARG           | NAME/REPL/SIZE,..  | array size(shape) permutatation   |
| TAG=ARG            | NAME               |                                   |
...
=LAY=(=LLAY=) operator evaluates the operands sequentally, stop when
