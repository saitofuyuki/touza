    ...
    if (ierr.eq.0) call reg_opr_prop(ierr, opr_EQB, str_EQB, 2, 1)
    if (ierr.eq.0) call reg_opr_prop(ierr, opr_NEB, str_NEB, 2, 1)
    if (ierr.eq.0) call reg_opr_prop(ierr, opr_LTB, str_LTB, 2, 1)
    if (ierr.eq.0) call reg_opr_prop(ierr, opr_GTB, str_GTB, 2, 1)
    if (ierr.eq.0) call reg_opr_prop(ierr, opr_LEB, str_LEB, 2, 1)
    if (ierr.eq.0) call reg_opr_prop(ierr, opr_GEB, str_GEB, 2, 1)
    ...
    if (ierr.eq.0) call reg_opr_prop(ierr, opr_ROR, str_ROR, 2, 1)
    if (ierr.eq.0) call reg_opr_prop(ierr, opr_XOR, str_XOR, 2, 1)
    if (ierr.eq.0) call reg_opr_prop(ierr, opr_LAND, str_LAND, 2, 1)
