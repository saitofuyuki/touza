...
dnl Time-stamp: <2021/01/13 16:48:34 fuyuki atpackage.m4>
...
AT_FORTRAN_BATCH_CHECK_STATEMENT([inquire], [iolength],[
integer L
...
AS_IF([test "x[$]AT_FORTRAN_CACHE_ID([iso_fortran_env])" != xyes],
      [at_stdin_def=5;  at_stdout_def=6;  at_stderr_def=0],
      [at_stdin_def=-1; at_stdout_def=-1; at_stderr_def=-1])

AT_VAR_SET_DEFAULT([OPT_STDIN_UNIT],  [[$]at_stdin_def])
AT_VAR_SET_DEFAULT([OPT_STDOUT_UNIT], [[$]at_stdout_def])
AT_VAR_SET_DEFAULT([OPT_STDERR_UNIT], [[$]at_stderr_def])
